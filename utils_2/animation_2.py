...
def plot_animations(test_model, normalized_test_data, Brr, nan_mask, num_runs, color_limits=None, save_path=None, on_cluster=False, normalise=True, testing_statistics=None):
    """
